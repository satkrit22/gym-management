...
<body class="bg-info">
  <div class="mb-3 text-center text-white mt-5" style="font-size: 30px;">
    <!-- <i class="fas fa-stethoscope"></i> -->
    <span><u><b>Grande Fitness Club</b></u></span>
  </div>
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret text-danger"></i> <span><u>Admin
      Area</u></span>
  </p>
    ...
    <div class="row justify-content-center custom-margin">
      ...
      <?php if(isset($msg)) {echo $msg; } ?>
        <form action="" class="shadow-lg p-4 bg-white" method="POST">
          ...
          <button type="submit" class="btn btn-danger mt-3 btn-block shadow-sm font-weight-bold">Login</button>
